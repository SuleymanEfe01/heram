...
exports.run = async (client, message, args) => {
  if(message.author.id !== "753674424716230807") if(message.author.id !== "753674424716230807") return message.channel.send("**Bu Komut Sahiplerime Özeldir.**");
...
client.channels.cache.get('753674424716230807').send( new Discord.MessageEmbed() .setDescription(`**<@${nesne}> ID'li Kullanıcı Gold Üyelikten çıkartıldı.**`) .setColor('BLUE'))
}
exports.conf = {
  enabled: true,
  guildOnly: false,
