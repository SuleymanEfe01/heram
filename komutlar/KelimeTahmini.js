...
db.set(`EpikCraft`,`Bu oyunu oynadığınız botun ismi.`)
...
//Amil <3 ///////////////////
      var kelimeler = ['Klostrofobi','Türkçe','Domates','Otel','Söğüt','Veteriner','EpikCraft','Rythm','Magnum','Lüksemburg','Deve'];
...
if (!message.author.bot) { 
              ...
              console.log('ahmetosmantr adamdır') //burayı silende ne bilim.
              console.log('ahmetosmantr#1453')
        ...
        .setFooter(`${client.user.username} ` + 'Kelime tahmini sistemi', client.user.avatarURL )
               ...
               db.set(`ktbalance_${message.author.id}_d0ru`, balance - ekpoint)   //ahmetosmantr#1453
                collector.stop('ahmetosmantr')
             }}
        })    
};
...
exports.help = {
  name: 'kelimetahmin',
  description: 'ahmetsoamntr ye aittir aksini iddia edene hakkım haramdır.',
